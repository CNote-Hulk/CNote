...
(function() {
    ...
    function createProfileDropdown() {
        ...
        var name = escapeHtml(user.username || 'Utilizator');
        var email = escapeHtml(user.email || 'Fara email');
        ...
        dd.innerHTML =
            ...
            '<a href="' + resolvePagePath('profil.html') + '#anunturi" class="profile-dropdown__item">' +
                '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg> Anunțurile mele</a>' +
            '<a href="' + resolvePagePath('profil.html') + '#favorite" class="profile-dropdown__item">' +
                '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg> Anunțuri apreciate</a>' +
            '<a href="' + resolvePagePath('profil.html') + '#prieteni" class="profile-dropdown__item">' +
                '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> Prieteni</a>' +
            ...
            '<a href="' + resolvePagePath('statistici.html') + '" class="profile-dropdown__item">' +
                '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> Statistici</a>' +
