...
export const ProfileDropdownModule = {
    ...
    _createDropdown() {
        ...
        dd.innerHTML = `
            ...
            <a href="${this._resolvePagePath('profil.html')}#setari" class="profile-dropdown__item" data-i18n="profile_settings">
            ...
            <a href="${this._resolvePagePath('statistici.html')}" class="profile-dropdown__item" data-i18n="profile_stats">
            ...
            <div class="profile-dropdown__divider"></div>
            <button class="profile-dropdown__item profile-dropdown__logout" data-i18n="profile_logout">
