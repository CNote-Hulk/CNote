...
At the end of every task, also append an entry to JURNAL.md at repo root (create it if it doesn't exist yet) - plain history log of what happened, no strict format needed.
